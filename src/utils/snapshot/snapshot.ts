 ...
 *@author   RuntimeErroz<dariuszeng@qq.com>
**/
export function recordHandle(recordDom: HTMLDivElement, recorderParams: RecorderParams, isPixelated: boolean, isInverted: boolean) {
 ...
 *@author   RuntimeErroz<dariuszeng@qq.com>
**/
export function screenshotHandle(playerInstance: Ref<VideoJsPlayer>, isPixelated: boolean, isInverted: boolean) {
  let video
...
function drawMedia(recorderParams: RecorderParams) {
  ...
  recorderParams.animationFrame = requestAnimationFrame(() => drawMedia(recorderParams));
}
